...
export async function createContactAction(_: any, formData: FormData) {
  ...
  const res = await apiFetch<ContactMessage>("/api/contacts", { method: "POST", body: payload })
...
export async function updateContactAction(_: any, formData: FormData) {
  ...
  const res = await apiFetch<ContactMessage>(`/api/contacts/${id}`, { method: "PATCH", body: payload })
  if (!res.ok) return { error: res.error }
  revalidatePath("/admin/contacts")
  return { ok: true }
}
...
export async function createStockAction(_: any, formData: FormData) {
  ...
  const res = await apiFetch<StockItem>("/api/stock", { method: "POST", body: payload })
  if (!res.ok) return { error: res.error }
...
export async function createWorkerAction(_: any, formData: FormData) {
  ...
  const res = await apiFetch<Worker>("/api/workers", { method: "POST", body: payload })
  if (!res.ok) return { error: res.error }
...
export async function createUserAction(_: any, formData: FormData) {
  ...
  const res = await apiFetch<User>("/api/users", { method: "POST", body: payload })
  if (!res.ok) return { error: res.error }
...
export async function createOrderAction(_: any, formData: FormData) {
  ...
  const res = await apiFetch<Order>("/api/orders", { method: "POST", body: payload })
  if (!res.ok) return { error: res.error }
...
export async function createInvoiceAction(_: any, formData: FormData) {
  ...
  const res = await apiFetch<Invoice>("/api/invoices", { method: "POST", body: payload })
  if (!res.ok) return { error: res.error }
...
export async function createReceiptAction(_: any, formData: FormData) {
  ...
  const res = await apiFetch<Receipt>("/api/receipts", { method: "POST", body: payload })
  if (!res.ok) return { error: res.error }
